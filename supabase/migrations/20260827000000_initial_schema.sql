...
-- Description: Initial schema for ShopCRUD application
...
CREATE POLICY "Allow all access to cart_items" ON public.cart_items FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all access to order_items" ON public.order_items FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all access to favorites" ON public.favorites;
CREATE POLICY "Allow all access to favorites" ON public.favorites FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
